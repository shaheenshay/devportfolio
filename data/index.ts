  ...
  export const projects = [
    {
      ...
      img: "/p1.png",
      iconLists: ["/next.svg", "/ts.svg", "/tail.svg", "/app.svg", "/twilio.svg"],
      link: "https://github.com/shaheenshay/DocCarePlus",
    },
    {
      id: 2,
      title: "A CRM Dashboard",
      des: "React-based CRM dashboard featuring comprehensive authentication, antd charts, sales management, and a fully operational kanban board with live updates for real-time actions across all devices.",
      img: "/p2.png",
      iconLists: ["/re.svg", "/ts.svg",  "/graph.svg", "/ant.svg", "/vite.svg"],
      link: "https://github.com/shaheenshay/Admin-Dashboard",
    },
    {
      id: 3,
      title: "3D Personal Portfolio",
      des: "A 3D developer portfolio built with React and Three.js, featuring interactive showcases of skills and projects. It uses Vite for fast development with Hot Module Replacement (HMR) and includes ESLint for code quality.",
      img: "/p3.png",
      iconLists: ["/re.svg", "/tail.svg", "/three.svg", "/vite.svg",],
      link: "https://github.com/shaheenshay/3D_Portfolio",
    },
    {
      id: 4,
